...
\textit{Il s'agit ici de mettre en application la partie 1 en calculant une valeur approchée de $\log(2)$ sur p d\'ecimales, tout en \'evaluant l'erreur relative obtenue. L'algorithme~\ref{alg:algo_ln} (codé en python) est celui qui sera utilisé.}
